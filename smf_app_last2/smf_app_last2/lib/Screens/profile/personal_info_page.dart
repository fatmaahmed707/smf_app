...
class _PersonalInfoPageState extends State<PersonalInfoPage> {
  ...
  // ── Emergency Contact ────────────────────────────────────────────────────
  final _emergencyNameCtrl = TextEditingController(text: "");
  final _relationshipCtrl = TextEditingController(text: "");
  final _emergencyPhoneCtrl = TextEditingController(text: "");
  final _secondaryCtrl = TextEditingController(text: "");
  final _doctorPhoneCtrl = TextEditingController(text: "");
  final _hospitalCtrl = TextEditingController(text: "");
          ...
          child: Column(
            ...
            children: [
              ...
              _sectionHeader(
                ...
                label:
                    lang.isArabic ? "جهة الاتصال للطوارئ" : "Emergency Contact",
                accent: Colors.redAccent,
              ),
              const SizedBox(height: 12),
              _card(cardColor, borderColor, [
                _field(isDark,
                    label: lang.isArabic ? "الاسم" : "Contact Name",
                    ctrl: _emergencyNameCtrl,
                    icon: Icons.person_outline),
                _field(isDark,
                    label: lang.isArabic ? "صلة القرابة" : "Relationship",
                    ctrl: _relationshipCtrl,
                    icon: Icons.people_outline),
                _field(isDark,
                    label: lang.isArabic ? "رقم الهاتف" : "Phone Number",
                    ctrl: _emergencyPhoneCtrl,
                    icon: Icons.phone_outlined,
                    type: TextInputType.phone),
                _field(isDark,
                    label: lang.isArabic
              ...
              _sectionHeader(
                ...
                label: lang.isArabic ? "المعلومات الطبية" : "Medical Info",
                accent: Colors.teal,
              ),
              const SizedBox(height: 12),
              _card(cardColor, borderColor, [
                _field(isDark,
                    label: lang.isArabic ? "هاتف الطبيب" : "Doctor Phone",
